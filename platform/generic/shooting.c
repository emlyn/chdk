...
{
#if !defined (CAMERA_ixus700_sd500) && !defined (CAMERA_ixus800_sd700) && !defined(CAMERA_ixus850_sd800) && !defined (CAMERA_a560) && !defined (CAMERA_a460) && !defined (CAMERA_ixus55_sd450)
    short tvv;
    long i;
...
//#if defined(CAMERA_ixus700_sd500) || defined (CAMERA_ixus70_sd1000) || defined (CAMERA_ixus950_sd850) || defined(CAMERA_ixus800_sd700) || defined(CAMERA_ixus65_sd630) || defined (CAMERA_ixus850_sd800) || defined (CAMERA_ixus55_sd450)
...
{
#if defined (CAMERA_ixus700_sd500) || defined (CAMERA_ixus800_sd700) || defined (CAMERA_ixus850_sd800) || defined (CAMERA_ixus70_sd1000) || defined (CAMERA_ixus950_sd850) || defined (CAMERA_a560) ||  defined (CAMERA_g7) || defined (CAMERA_a460) || defined (CAMERA_ixus55_sd450)
	if (is_now) {
