...
You have a vxworks Camera, so follow this procedure to get your cam started with CHDK:

- exract the archive onto the sdcard (using an sdcard reader)
- insert the card into the camera
- start camera IN PLAYMODE
- open menu
and so on... please somebody else write this readme :D
-explain vers.req

Or for windows users: use cardtricks (will be included here later)
