...
/* !!! Do NOT change ID for items defined already! Append a new one at the end! !!! */
    ...
    CONF_INFO(170, conf.osd_color_override,     CONF_DEF_VALUE, cl:MAKE_COLOR(COLOR_BG, COLOR_RED), NULL),
    CONF_INFO(171, conf.override_disable,       CONF_DEF_VALUE, i:2, NULL),
    CONF_INFO(172, conf.override_disable_all,   CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(173, conf.hide_osd_in_playback,   CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(174, conf.save_raw_in_video,      CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(175, conf.show_movie_time,        CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(176, conf.show_movie_refresh,     CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(177, conf.mode_video_pos,         CONF_DEF_PTR,   ptr:&def_mode_video_pos , NULL),
    CONF_INFO(178, conf.clear_video,            CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(179, conf.fast_ev,                CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(180, conf.fast_ev_step,           CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(181, conf.mode_ev_pos,            CONF_DEF_PTR,   ptr:&def_mode_ev_pos , NULL),
    CONF_INFO(182, conf.menu_symbol_enable,     CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(183, conf.menu_symbol_color,      CONF_DEF_VALUE, cl:MAKE_COLOR(COLOR_BG, COLOR_FG), NULL),
    CONF_INFO(184, conf.curve_file,             CONF_DEF_PTR, ptr:"", NULL),
    CONF_INFO(185, conf.curve_enable,           CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(186, conf.edge_overlay_enable,    CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(187, conf.edge_overlay_thresh,    CONF_DEF_VALUE, i:40, NULL),
    CONF_INFO(188, conf.edge_overlay_color,     CONF_DEF_VALUE, cl:0x66, NULL),
    CONF_INFO(189, conf.synch_enable,           CONF_DEF_VALUE, i:1, NULL),
    CONF_INFO(190, conf.synch_delay_enable,     CONF_DEF_VALUE, i:0, NULL),
    CONF_INFO(191, conf.synch_delay_value,      CONF_DEF_VALUE, i:100, NULL),
    CONF_INFO(192, conf.synch_delay_coarse_value, CONF_DEF_VALUE, i:0, NULL),
};
